...
class SkeletonAnalyzerGuoHall:
    ...
    def to_binary(self, invert=False):
        ...
        # Elliptical Kernels 3x3 and 7x7
...
class GraphSkeletonAnalyzer:
    ...
    def find_dijkstra_path(self, skeleton_img):
        ...
        # Line Regression & Extreme Branch Elimination
        ...
        if best_start == -1 or best_end == -1: return []
...
if __name__ == "__main__":
    ...
    mtx, dist = None, None
    if USE_UNDISTORT:
        mtx, dist = load_calibration_data(CALIBRATION_PATH)
    ...
    # 2. Binary and Skeleton Processing (Without AI Crop)
    ...
    # 3. Dijkstra Process
    graph_tool = GraphSkeletonAnalyzer()
    dijkstra_path = graph_tool.find_dijkstra_path(raw_skeleton)
    
    print("\n✅ Final Result: Dijkstra route successfully extracted and visualized.")
    
    # 4. Visualization
    final_vis_rgb = graph_tool.visualize_on_image(img_rgb, raw_skeleton, dijkstra_path)
    ...
    plt.title("4. Dijkstra Centerline")
    plt.axis('off')
